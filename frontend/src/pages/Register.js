        ...
        <Box h={"100%"} w={"100%"} maxHeight="100vh">
            <Container as={Flex} alignItems="center" justifyContent="center" maxW={"container.sm"} h={"100%"}>
                <Box minW={"448px"} bg={"white"} boxShadow="1em 1em 10px rgba(0, 0, 0, 0.1), 0.5em 0.5em 10px rgba(255, 0, 0, 0.2)" p="2em 1em">
                    ...
                    <Flex onSubmit={submitRegister} as={"form"} mt="1em" flexDirection="column" style={{gap: "1em"}}>
                        <FormControl>
                            <Input id="name" type={"text"} placeholder="Name" value={getName} onChange={(e) => setName(e.target.value)}/>
                        </FormControl>
                        <FormControl>
                        ...
                        <Button type='submit' maxWidth={"224px"}>Register</Button>
                    </Flex>
                    <Text mt={3}>Already have account? <Link to={"/login"}>login</Link></Text>
                </Box>
            </Container>
        </Box>
    )
